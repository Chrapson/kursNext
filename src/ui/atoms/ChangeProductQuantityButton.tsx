	...
	return (
		<form className="flex w-full items-center gap-4">
			<button
				...
				className="rounded-md bg-white p-4 py-1 transition-colors hover:bg-gray-200 disabled:cursor-not-allowed disabled:bg-gray-300 disabled:opacity-50"
			>
				-
			</button>
			...
			<button
				...
				className="rounded-md bg-white p-4 py-1 transition-colors hover:bg-gray-200"
			>
				+
			</button>
		</form>
