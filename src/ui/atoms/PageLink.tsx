...
export const PageLink = ({ href, name }: CardLinkProps) => (
	<Link className="group relative transition-transform hover:scale-105" href={href}>
		<figure className="h-[340px]">
			<li className="h-full w-full rounded-xl object-cover transition-all hover:shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)]" />
