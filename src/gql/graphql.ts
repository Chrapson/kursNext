...
export type CategoryGetItemQuery = { category?: { id: string, name: string, description: string, slug: string, products: Array<{ id: string, name: string, price: number, description: string, rating?: number | null, images: Array<{ url: string, alt: string }>, categories: Array<{ name: string }> }> } | null };
...
export type CollectionGetItemQuery = { collection?: { id: string, name: string, slug: string, description: string, products: Array<{ id: string, name: string, price: number, description: string, rating?: number | null, images: Array<{ url: string, alt: string }>, categories: Array<{ name: string }> }> } | null };

export type CollectionsGetListQueryVariables = Exact<{ [key: string]: never; }>;


export type CollectionsGetListQuery = { collections: { data: Array<{ id: string, name: string, slug: string, description: string }> } };

export type CollectionsGetListItemFragment = { id: string, name: string, slug: string, description: string };

export type ProductListFragment = { id: string, name: string, price: number, description: string, rating?: number | null, images: Array<{ url: string, alt: string }>, categories: Array<{ name: string }> };
...
export type ProductGetItemByIdQuery = { product?: { description: string, id: string, rating?: number | null, name: string, price: number, categories: Array<{ name: string }>, images: Array<{ alt: string, url: string }> } | null };

export type ProductsListItemFragment = { id: string, name: string, price: number, description: string, rating?: number | null, images: Array<{ url: string, alt: string }>, categories: Array<{ name: string }> };
...
export type ProductsGetListQuery = { products: { data: Array<{ id: string, name: string, description: string, rating?: number | null, price: number, categories: Array<{ name: string }>, images: Array<{ url: string, alt: string }> }>, meta: { total: number } } };
...
export type ProductsGetSuggestedListQuery = { products: { data: Array<{ id: string, name: string, description: string, rating?: number | null, price: number, categories: Array<{ name: string }>, images: Array<{ url: string, alt: string }> }>, meta: { total: number } } };

export type ProductsGetTotalCountFragment = { meta: { total: number } };

export type SuggestedProductsGetListQueryVariables = Exact<{ [key: string]: never; }>;


export type SuggestedProductsGetListQuery = { products: { data: Array<{ id: string, name: string, price: number, description: string, rating?: number | null, images: Array<{ url: string, alt: string }>, categories: Array<{ name: string }> }>, meta: { total: number } } };
...
export const CollectionsGetListItemFragmentDoc = new TypedDocumentString(`
  ...
  description
    ...
    `, {"fragmentName":"CollectionsGetListItem"}) as unknown as TypedDocumentString<CollectionsGetListItemFragment, unknown>;
...
export const ProductsGetTotalCountFragmentDoc = new TypedDocumentString(`
    fragment ProductsGetTotalCount on ProductList {
  meta {
    total
  }
}
    `, {"fragmentName":"ProductsGetTotalCount"}) as unknown as TypedDocumentString<ProductsGetTotalCountFragment, unknown>;
