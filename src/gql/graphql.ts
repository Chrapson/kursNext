...
export type CategoriesGetListQuery = {
	categories: {
		data: Array<{ " $fragmentRefs"?: { CategoriesListItemFragment: CategoriesListItemFragment } }>;
...
export type CategoryGetItemQuery = {
	category?:
		| ({
				products: Array<{
					" $fragmentRefs"?: { ProductsListItemFragment: ProductsListItemFragment };
				}>;
		  } & { " $fragmentRefs"?: { CategoriesListItemFragment: CategoriesListItemFragment } })
		| null;
};

export type CategoriesListItemFragment = {
	id: string;
	name: string;
	slug: string;
	description?: string;
...
export type ProductsListItemFragment = {
	...
	images: Array<{ url: string; alt: string }>;
	categories: Array<{ name: string }>;
} & { " $fragmentName"?: "ProductsListItemFragment" };
...
export type ProductsGetListBySearchQuery = {
	products: {
		data: Array<{ " $fragmentRefs"?: { ProductsListItemFragment: ProductsListItemFragment } }>;
		meta: { total: number };
	};
};
...
export type ProductsGetSuggestedListQuery = {
	products: {
		data: Array<{
			id: string;
			name: string;
...
export type ProductsGetTotalCountFragment = { meta: { total: number } } & {
	" $fragmentName"?: "ProductsGetTotalCountFragment";
};
...
export const ProductsGetTotalCountFragmentDoc = new TypedDocumentString(
  ...
  meta {
    ...
    `,
	{ fragmentName: "ProductsGetTotalCount" },
) as unknown as TypedDocumentString<ProductsGetTotalCountFragment, unknown>;
...
export const ProductsGetListBySearchDocument = new TypedDocumentString(`
  ...
  categories {
	...
	ProductsGetListBySearchQuery,
	ProductsGetListBySearchQueryVariables
>;
export const ProductsGetSuggestedListDocument = new TypedDocumentString(`
  ...
  products {
    ...
    `) as unknown as TypedDocumentString<
	ProductsGetSuggestedListQuery,
	ProductsGetSuggestedListQueryVariables
>;
